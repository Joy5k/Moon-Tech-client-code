...
import { addToCart, removeFromCart } from "../redux/actionCreators/addToCart";
     ...
     {pathname.includes('cart')&& <div className= "grid place-items-center bg-indigo-500 text-white h-8 w-8 rounded-full absolute top-2 right-2  ">
      ...
      <div className='flex gap-2 mt-5'>
        {pathname.includes('cart')&&
          <button onClick={() => dispatch(removeFromCart(product))} className='bg-red-500 rounded-full px-2 flex justify-between items-center
           text-white text-bold flex-1'>
